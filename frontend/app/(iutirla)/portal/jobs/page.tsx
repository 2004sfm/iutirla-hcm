            ...
            <div className="mx-auto mb-12 max-w-2xl">
                <div className="relative">
                    ...
                    <input
                        ...
                        className="w-full rounded-full border border-slate-300 py-4 pl-12 pr-4 shadow-sm transition-all focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500"
                    />
                </div>
            </div>
